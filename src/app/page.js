      ...
      <main className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          Manage / Cancel Subscription
               ...
               {/* ⚖️ LEGAL SAFETY DISCLAIMER CARD BLOCK PANEL - WITH CONTENT VIOLATION PROTECTION */}
        <div className="mt-2 max-w-2xl bg-slate-950 border border-slate-900/60 p-4 rounded-lg text-left font-mono">
          ...
          <p className="text-[9px] text-slate-500 leading-relaxed">
            GameyGrid operates strictly as a neutral spatial hosting canvas. All drawings, logos, and destination links are provided entirely by third-party users. GameyGrid does not guarantee the integrity or safety of external links, nor does he guarantee uninterrupted platform uptime. Under no circumstances shall the platform be held liable for temporary system downtime, hosting disruptions, or network outages due to maintenance. Furthermore, GameyGrid is completely immune from liabilities concerning third-party malware, digital fraud, phishing scripts, or malicious intent originating from user-allocated slots; users navigate outbound links entirely at their own risk. <strong>Payment Default Policy:</strong> Continuous grid placement is strictly contingent upon successful, timely subscription clearance through Stripe. In the event of a payment default, failed auto-renewal transaction, or immediate subscription cancellation, GameyGrid reserves the absolute right to instantly terminate the space allocation without prior notice. <strong>Acceptable Use & +18 Content Restrictions:</strong> GameyGrid maintains a strict zero-tolerance policy toward adult content, explicit imagery (+18), pornography, violence, hate speech, or links leading to explicit third-party sites. GameyGrid reserves the absolute right to pre-screen, audit, and instantly delete any graphic asset or hyperlink deemed inappropriate, offensive, or violating these guidelines without prior warning. In the event of a content guidelines violation, the offending space allocation will be permanently terminated, and any processed subscription fees will be forfeited as a compliance penalty with zero eligibility for refunds.
          </p>
        </div>
      </footer>
